<template>
    ...
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <!--  <el-input v-model="dataForm.shelfName" placeholder="货架" clearable></el-input> -->
        <el-col :span="12" class="shelf-group"  v-for="item in shelf" :key="item.shelfName">
           
            <el-button @click="getDataList(item.shelfName)" class="button1" type="info"> 
            {{ item.shelfName }}
            </el-button>
      ...
      <el-col :span="18">
        <el-card class="backgroud">
         <el-col :span="8" class="shelfdata-group"  v-for="item in dataList" :key="item.valueSelect" v-model="dataForm.valueSelect"> 
           <el-button type="success" class="shelfdata">
            {{item.valueSelect}}
           数量： 
           {{ item.realCount}}
           </el-button>
