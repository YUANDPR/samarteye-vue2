<template>
  ...
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="warestockId" header-align="center" align="center" label="warestockId"></el-table-column>
      <el-table-column prop="wlppName" header-align="center" align="center" label="仓库"></el-table-column>
      <el-table-column prop="wlpName" header-align="center" align="center" label="二级分区"></el-table-column>
      <el-table-column prop="wlName" header-align="center" align="center" label="三级分区"></el-table-column>
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.warestockId)">修改预警库存</el-button>
          <el-button type="text" size="small" @click="deleteHandle(scope.row.warestockId)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
