<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="buyDemandId" header-align="center" align="center" label="buyDemandId"></el-table-column>
      <el-table-column prop="buyListId" header-align="center" align="center" label="采购单id"></el-table-column>
      <el-table-column prop="warestockId" header-align="center" align="center" label="采购品id"></el-table-column>
      <el-table-column prop="valueSelect" header-align="center" align="center" label="采购品名称"></el-table-column>
      <el-table-column prop="buyNum" header-align="center" align="center" label="采购数量"></el-table-column>
      <el-table-column prop="origin" header-align="center" align="center" label="来源">
         <template slot-scope="scope">
          <el-tag type="info" v-if="scope.row.origin==1">库存预警</el-tag>
          <el-tag type="success" v-if="scope.row.origin==0">主动采购</el-tag>
        </template>
      </el-table-column>  
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.buyDemandId)">修改</el-button>
          <el-button type="text" size="small" @click="deleteHandle(scope.row.buyDemandId)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
    ...
    <el-dialog title="合并采购需求" :visible.sync="mergedialogVisible">
      <!-- id  assignee_id  assignee_name  phone   priority status -->
      <el-select v-model="buyListId" placeholder="请选择" clearable filterable>
        <el-option
