<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="buyListName" header-align="center" align="center" label="采购单名称"></el-table-column>
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          ...
          >分配</el-button>
          <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.buyListId)">修改</el-button>
          <el-button type="text" size="small" @click="deleteHandle(scope.row.buyListId)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
