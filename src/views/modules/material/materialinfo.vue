<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="materialId" header-align="center" align="center" label="materialId"></el-table-column>
      <el-table-column prop="materialName" header-align="center" align="center" label="货物名称"></el-table-column>
      <el-table-column prop="materialDescription" header-align="center" align="center" label="描述"></el-table-column>
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          ...
          >上架</el-button>
          <el-button type="text" size="small" @click="detailShow(scope.row.materialId)">详情</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<el-dialog title="出库单详情" :visible.sync="dialogTableVisible">
  <el-table :data="gridData">
    ...
    <el-table-column property="onematerialCount" label="数量"></el-table-column>
