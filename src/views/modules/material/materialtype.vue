    ...
    <el-col :span="18">
      <div class="mod-config">
        ...
        >
          ...
          <el-table-column align="center" header-align="center" label="库存种类"
          ...
          >
            <template slot-scope="scope">
              <el-button size="small" type="text" @click="addOrUpdateHandle(scope.row.materialTypeId)">修改</el-button>
              <el-button size="small" type="text" @click="deleteHandle(scope.row.materialTypeId)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination
...
export default {
  ...
  methods: {
    ...
    getDataList () {
      ...
      this.$http({
        url: this.$http.adornUrl(`/material/materialtype/${type}/list/${this.wlId}`),
        method: 'get',
    ...
    deleteHandle (id) {
      ...
      this.$confirm(
        ...
        this.$http({
          url: this.$http.adornUrl('/material/materialtype/delete'),
          method: 'post',
