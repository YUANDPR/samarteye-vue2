    ...
    <el-col :span="6">
      <div style="height: 700px;">
        <el-steps :active="active" direction="vertical">
          ...
          <el-step description="已提交的申请可转至[物料申请状态]查看" title="3.提交申请"></el-step>
        </el-steps>
      </div>
    </el-col>
    ...
    <el-col :span="16">
      <el-form ref="dataForm" :model="dataForm" :rules="rules" class="demo-dataForm" label-width="100px">
        ...
        <el-form-item label="" prop="mbillDescription">
          <el-col v-show="dataResp.stepd[0]==1" :span="24">
        ...
        <el-form-item>
          <el-button v-show="dataResp.stepd[0]==1" type="primary" @click="generateSkus">核对物料信息</el-button>
        </el-form-item>
        ...
        <el-form-item>
          <el-button v-show="dataResp.stepd[1]==1" type="success" @click="submitmaterial">提交申请</el-button>
        </el-form-item>
