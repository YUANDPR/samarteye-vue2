    ...
    <el-col :span="6">
      <div style="height: 700px;">
        <el-steps :active="active" direction="vertical">
          ...
          <el-step description="已生成的出库单可转至[出库单]查看" title="3.生成出库单"></el-step>
        </el-steps>
      </div>
    </el-col>

    <el-col :span="16">
      <el-form ref="dataForm" :model="dataForm" :rules="rules" class="demo-dataForm" label-width="100px">
        ...
        <el-form-item v-show="dataForm.outtype=='物料申请单出库'" label="物料申请单ID" prop="mbillId">
        ...
        <el-form-item label="出库分区">
          <el-cascader :options="options" :props="setting" clearable @change="cascadeChange"></el-cascader>
        </el-form-item>


        <el-form-item v-show="dataResp.stepd[0]==1" label="" prop="mbillDescription">
          <el-col :span="15">
          ...
          <el-col :span="5">
            库存剩余
            <el-input v-model="realCount" disabled size="small"
                      style="width:115px"
            ></el-input>
          </el-col>
        </el-form-item>
        ...
        <el-form-item>
          <el-button v-show="dataResp.stepd[0]==1" type="primary" @click="generateSkus">核对库存信息</el-button>
        </el-form-item>

        <el-form-item>
          <el-col v-show="dataResp.stepd[1]==1" :span="24">
        ...
        <el-form-item>
          <el-button v-show="dataResp.stepd[1]==1" type="success" @click="submitstock">生成出库单</el-button>
        </el-form-item>
