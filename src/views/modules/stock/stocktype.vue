    ...
    <el-col :span="18">
      <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
          <el-form-item>
            <el-input v-model="dataForm.key" clearable placeholder="id、库存种类"></el-input>
          </el-form-item>
          <el-form-item>
        ...
        >
          ...
          <el-table-column align="center" header-align="center" label="所属分区" prop="wlName"></el-table-column>
          <el-table-column
            v-if="attrtype == 1"
            align="center"
            header-align="center"
          ...
          >
            <template slot-scope="scope">
              <el-button size="small" type="text" @click="addOrUpdateHandle(scope.row.stockTypeId)">修改</el-button>
              <el-button size="small" type="text" @click="deleteHandle(scope.row.stockTypeId)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination
