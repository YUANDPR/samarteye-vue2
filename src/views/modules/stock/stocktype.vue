    ...
    <el-col :span="18">
      <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
          <el-form-item>
            <el-input v-model="dataForm.key" placeholder="id、库存种类" clearable></el-input>
          </el-form-item>
          <el-form-item>
        ...
        >
          ...
          <el-table-column prop="stockTypeName" header-align="center" align="center" label="库存种类"></el-table-column>
          ...
          <el-table-column prop="wlName" header-align="center" align="center" label="所属分区"></el-table-column>
          <el-table-column
            v-if="attrtype == 1"
            prop="shelfName"
            header-align="center"
          ...
          >
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.stockTypeId)">修改</el-button>
              <el-button type="text" size="small" @click="deleteHandle(scope.row.stockTypeId)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination
...
import AddOrUpdate from "./stocktype-add-or-update";
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl(`/stock/stocktype/${type}/list/${this.wlId}`),
        method: "get",
    ...
    deleteHandle(id) {
      ...
      this.$confirm(
        ...
        this.$http({
          url: this.$http.adornUrl("/stock/stocktype/delete"),
          method: "post",
