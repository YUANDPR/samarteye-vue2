<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="outbillId" header-align="center" align="center" label="outbillId"></el-table-column>
      <el-table-column prop="outbillName" header-align="center" align="center" label="出库单名称"></el-table-column>
      <el-table-column prop="outbillDescription" header-align="center" align="center" label="描述"></el-table-column>
      <el-table-column prop="wlId" header-align="center" align="center" label="分区"></el-table-column>
        <el-table-column prop="outtype" header-align="center" align="center" label="出库类型">
      ...
      <el-table-column prop="createTime" header-align="center" align="center" label="生成时间"></el-table-column>
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          ...
          >打印出库单</el-button>
           <el-button type="text" size="small" @click="detailShow(scope.row.outbillId)">详情</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<el-dialog title="出库单详情" :visible.sync="dialogTableVisible">
  <el-table :data="gridData">
    ...
    <el-table-column property="outbilldetailCount" label="数量"></el-table-column>
