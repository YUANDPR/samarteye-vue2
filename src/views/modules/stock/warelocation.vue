...
export default {
  ...
  methods: {
    ...
    getchart1data () {
      this.$http({
        url: this.$http.adornUrl('/stock/warelocation/list/echarts'),
        method: 'get'
      }).then(({data}) => {
    ...
    batchDelete () {
      ...
      this.$confirm(`是否批量删除【${wlIds}】菜单?`, '提示', {
        ...
        .then(() => {
          this.$http({
            url: this.$http.adornUrl('/stock/warelocation/delete'),
            method: 'post',
    ...
    batchSave () {
      this.$http({
        url: this.$http.adornUrl('/stock/warelocation/update/sort'),
        method: 'post',
    ...
    edit (data) {
      ...
      //发送请求获取当前节点最新的数据
      this.$http({
        url: this.$http.adornUrl(`/stock/warelocation/info/${data.wlId}`),
        method: 'get'
      }).then(({data}) => {
        //请求成功
    ...
    editCategory () {
      ...
      this.$http({
        url: this.$http.adornUrl('/stock/warelocation/update'),
        method: 'post',
    ...
    addCategory () {
      ...
      this.$http({
        url: this.$http.adornUrl('/stock/warelocation/save'),
        method: 'post',
