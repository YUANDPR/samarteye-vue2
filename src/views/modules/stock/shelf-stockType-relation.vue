<template>
  <div>
    <el-dialog :close-on-click-modal="false" :visible.sync="visible" @closed="dialogClose">
      <el-dialog width="40%" title="选择库存种类" :visible.sync="innerVisible" append-to-body>
        <div>
          ...
          >
            ...
            <el-table-column prop="stockTypeId" header-align="center" align="center" label="id"></el-table-column>
            <el-table-column prop="stockTypeName" header-align="center" align="center" label="种类名"></el-table-column>
      ...
      <el-row>
        <el-col :span="24">
          ...
          >
            ...
            <el-table-column prop="stockTypeId" label="#"></el-table-column>
            <el-table-column prop="stockTypeName" label="库存种类名"></el-table-column>
            ...
            <el-table-column fixed="right" header-align="center" align="center" label="操作">
              <template slot-scope="scope">
                <el-button type="text" size="small" @click="relationRemove(scope.row.stockTypeId)">移除</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-col>
