    ...
    <el-row :gutter="20">
      ...
      <el-col :span="8">
        <el-card class="a1">
          ...
          <el-col span="9">
            <el-progress :percentage=" Math.round((this.dataShow.todaymbCount/this.dataShow.todombCount)*100)"
      ...
      <el-col :span="8">
        <el-card class="a1">
          ...
          <el-col span="9">
            <el-progress :percentage="Math.round((this.dataShow.todayibCount/this.dataShow.todoibCount)*100)"
                         type="circle"></el-progress>
          </el-col>
        </el-card>
      </el-col>
      <el-col :span="8">
        <el-card class="a1">
          ...
          <el-col span="9">
            <el-progress :percentage="Math.round((this.dataShow.todayobCount/this.dataShow.todayobCount)*100)"
                         type="circle"></el-progress>
          </el-col>
        </el-card>
      </el-col>
